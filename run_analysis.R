...
subject_train = read.table("C:/Users/ricar/Desktop/coursera/UCI HAR Dataset/train/subject_train.txt", col.names=c("subject_id"))
# assign row number as the values of ID column
subject_train$ID <- as.numeric(rownames(subject_train))
# read training data
X_train = read.table("C:/Users/ricar/Desktop/coursera/UCI HAR Dataset/train/X_train.txt")
# assign row number as the values of ID column
X_train$ID <- as.numeric(rownames(X_train))
# read activity training data
y_train = read.table("C:/Users/ricar/Desktop/coursera/UCI HAR Dataset/train/y_train.txt", col.names=c("activity_id"))  # max = 6
...
# read subject training data
subject_test = read.table("C:/Users/ricar/Desktop/coursera/UCI HAR Dataset/test/subject_test.txt", col.names=c("subject_id"))
# assign row number as the values of ID column
subject_test$ID <- as.numeric(rownames(subject_test))
# read testing data
X_test = read.table("C:/Users/ricar/Desktop/coursera/UCI HAR Dataset/test/X_test.txt")
# assign row number as the values of ID column
X_test$ID <- as.numeric(rownames(X_test))
# read activity testing data
y_test = read.table("C:/Users/ricar/Desktop/coursera/UCI HAR Dataset/test/y_test.txt", col.names=c("activity_id"))  # max = 6
...
features = read.table("C:/Users/ricar/Desktop/coursera/UCI HAR Dataset/features.txt", col.names=c("feature_id", "feature_label"),)  #561
...
activity_labels = read.table("C:/Users/ricar/Desktop/coursera/UCI HAR Dataset/activity_labels.txt", col.names=c("activity_id", "activity_label"),) #
